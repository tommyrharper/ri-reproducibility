...
\hyperref[sec:param-frequency-range]{\texttt{start\_frequency\_hz}} & ? & First channel frequency \\
\hyperref[sec:param-frequency-range]{\texttt{channel\_width\_hz}} & ? & Uniform spacing between channels \\
\end{tabular}
