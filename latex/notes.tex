...
\caption{Merged nested-sampling failure score for the R2D2 and CLEAN searches. The plotted objective is the failure score used in place of a traditional likelihood.}
