...
A fresh three-repeat asynchronous WSClean control measured **110.2
evaluations/second** (105.4, 110.2, and 114.3) at 20 ranks, with **142.2
ms/evaluation** by median, **127.1-128.5 ms/evaluation** in the image binary,
